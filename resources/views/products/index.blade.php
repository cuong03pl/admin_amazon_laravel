                            ...
                            <table class="min-w-full divide-y divide-gray-200 table-fixed">
                                <div class="bg-white">
                                    <div class="grid grid-cols-12 w-full">
                                        ...
                                        <div scope="col" class="col-span-1 p-4 text-xs font-medium text-left text-gray-500 uppercase lg:p-5">
                                            Tags
                                        </div>
                                        <!-- <div scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase lg:p-5">
                                            Price
                                        </div> -->
                                ...
                                <div class="bg-white divide-y divide-gray-200">
                                    ...
                                    <div class="hover:bg-gray-100 grid grid-cols-12 w-full">
                                        ...
                                        <div class="p-4 col-span-1 text-base font-medium text-gray-900  lg:p-5">{{$product->tags}}</div>
                                        <!-- <div class="p-4 text-base font-medium text-gray-900  lg:p-5">$149</div> -->
                                        <div class="flex items-center p-4 col-span-4 space-x-2  lg:p-5">
